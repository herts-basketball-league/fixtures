...
<form method="POST">
			...
			<div class="border-gray-900/10 pb-12 dark:border-white/10">
				<div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
					...
					<div class="sm:col-span-2">
						...
						<div class="mt-2">
							<input id="name" type="text" name="name" autocomplete="team-name" class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6 dark:bg-white/5 dark:text-white dark:outline-white/10 dark:placeholder:text-gray-500 dark:focus:outline-indigo-500" maxlength="255" value={ data.team?.name || '' } required />
						</div>
					</div>
					...
					<div class="sm:col-span-2">
						...
						<div class="mt-2">
							<input id="shortName" type="text" name="shortName" autocomplete="team-short-name" class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6 dark:bg-white/5 dark:text-white dark:outline-white/10 dark:placeholder:text-gray-500 dark:focus:outline-indigo-500" maxlength="255" value={ data.team?.shortName || '' } />
						</div>
					</div>
				</div>
			</div>
	...
	<div class="mt-6 flex items-center justify-start gap-x-6">
		...
		<button type="button" class="text-sm/6 font-semibold text-gray-900 dark:text-white"><a href="/teams">cancel</a></button>
	</div>
</form>
